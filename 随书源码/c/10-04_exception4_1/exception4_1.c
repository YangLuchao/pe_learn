//测试异常处理
//与exception4不同之处，注册的异常处理程序为_handler2
...
//所以把0x1198处改为 40 26 40 00 后面紧接着填函数个数  02 00 00 00
//函数1在内存中地址为0x00401000，所以文件偏移0x1640修改为函数的内存偏移 00 10 00 00
//函数2在内存中地址为0x00401030，所以文件偏移0x1644修改为函数的内存偏移 30 10 00 00
//
